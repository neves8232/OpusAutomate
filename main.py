...
# class Opus(threading.Thread):
class Opus():

    def __init__(self, yt_link, username=None, domain=None, proxy_country="pt"):
        ...
        self.channel_fetch_id = config["video_settings"]["channel_fetch_id"]
        path_video = config["video_settings"]["path_video"]
        self.path = path_video + "\\" + self.channel + "\\"
    ...
    def run(self):
        ...
        self.driver.quit()
        yt_db.add_video(self.channel, self.channel_fetch_id, self.yt_link)
    ...
    def login(self):
        ...
        self.driver.get("https://clip.opus.pro/dashboard")
...
#     for link in videos_to_be_done:
#         thread = Opus(yt_link=link)
#         thread.start()
...
opus = Opus(yt_link=videos_to_be_done[0])


# TODO ADICIONAR DICIONARIO COM CATEGORIA: CHANNEL_ID:NUM_SHORT
# DB accounts vai ter mais uma coluna de "categoria"
